...
<div class="content-wrapper sd-board" id="blind-write">
		...
		<div
				class="container-xxl flex-grow-1 container-p-y sd-notice-write sd-blind">
				...
				<div class="row">
						...
						<div class="col-xxl">
								<div class="card mb-4">
										...
										<div class="card-body">
												<form id="frm-blind-register" method="POST"
														...
														<div class="row mb-3">
																...
																<div class="col-sm-10">
																		<input type="text" class="form-control"
																				name="boardTitle" id="board-title"
														...
														<div class="row mb-3">
																<label class="col-sm-2 col-form-label"
																		for="basic-default-name">비밀번호</label>
																<div class="col-sm-10">
																		<input type="password" class="form-control"
																				id="board-pw" name="password">
																</div>
																<p>
																		<span style="color: red">*</span> 추후 편집, 삭제를 위한 비밀번호를
																		입력해주세요.<br> 비밀번호를 잊어버린다면, 추후 편집, 삭제가 불가능합니다.
																</p>
														</div>
														<div class="btn-area">
																<button type="submit"
